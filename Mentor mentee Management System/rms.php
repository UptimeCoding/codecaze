...
<head>
    ...
    <title>MKCE MENTOR MENTEE MANAGEMENT SYSTEM</title>
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="navbar-header" style="background-color: orange">
                ...
                <a class="navbar-brand" href=""><b>&nbsp;&nbsp;&nbsp; <img src="logo.jpg" alt="..." width="5%">MKCE MENTOR MENTEE MANAGEMENT SYSTEM</b></a>
            </div>
            <!-- Top Menu Items -->
...
$page = $_GET['page'];
$pages = array('home', 'Students', 'subjects','student_p','records','record','addrecord','report','program','statistical','Report Form','list_report','student_report','users','school_year','grade','advisers','database','candidates','candidates_list', 'candidates_report','logs');
if (!empty($page)) {
      ...
      <div class="modal fade" id="s_report" role="dialog">
                ...
                <div class="modal-content">
                    ...
                    <form action="rms.php?page=list_report" method="POST">
                      <label class="control-label col-sm-3" for="pd">Collage Year:</label>
                      <br><br>
                      <div class="col-sm-2">          
