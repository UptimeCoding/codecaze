...
<div style="margin-left:.5in;margin-right:.5in;margin-top:.1in;margin-bottom:.1in;line-height:1mm;">
		...
		<p><center><b>Student Grading System</b></center></p>
		  ...
		  <div class="row">
		  <div class="col-md-12">
		  <center><p><b><h4>COLLEGE STUDENT'S PERMANENT RECORDS</h4></b></p></center>
		  </div>
          </div>
          <div class="row">
		  <div class="col-md-12">
		...
		<table>
			...
			<label style="font-size:12px">COLLEGE:&nbsp&nbsp&nbsp&nbsp&nbsp</label>
			</td>
		...
		?>
		<tr>
		<td style="width:150px;font-size:12px;height:15px">Days of COLLEGE:</td>
		...
		<td style="width:60;font-size:12px;height:15px;text-align:right">COLLEGE</td>
