          ...
          <h1 class="page-header">Collage Year</h1>
      <?php
       ...
       <div class="col-md-8 " id="s_page">
        ...
        <div class="panel-heading">
          <h3 class="panel-title">List of Collage Year</h3>
        </div> 
  ...
  <table id="students" class="table table-hover table-bordered">
    <thead>
      <tr>
        <th style="width:20%">Collage Year</th>
   ...
   var stats = $("#stats"+i).val();
    ...
    data = '<div class="form-group">'+
      ...
      <div class="row main">
        ...
        <h3 id="head">Add New Collage Year</h3>
          <form class="" method="post">
            <input type="hidden" id="id" name="id">
            <div class="form-group">
              <label for="sy" class="cols-sm-2 control-label">Collage Year</label>
              <div class="cols-sm-4">
